...
gcc -Ofast -mrdseed -fopenmp miner.c ecc.c base58.c -lm -o bin/gcc-miner-linux-64
clang -Ofast -mrdseed -fopenmp miner.c ecc.c base58.c -lm -o bin/clang-miner-linux-64
i686-w64-mingw32-gcc -Ofast -fopenmp miner.c ecc.c base58.c -static -static-libgcc -lm -o bin/miner-win-64.exe

gcc -Ofast -mrdseed -fopenmp gminer.c sha3.c ecc.c base58.c -lSDL2 -lm -o bin/gcc-gui-miner-linux-64
clang -Ofast -mrdseed -fopenmp gminer.c sha3.c ecc.c base58.c -lSDL2 -lm -o bin/clang-gui-miner-linux-64
